...
class Event extends BaseEventTask
{
    ...
    public static function load() : Dto
    {
        ...
        $dto->setDuration(
            $startDateTime->diff( $faker->dateTimeInInterval( $startDateTime, '+6 hours')) // from start and forward
        );

        $dto->setStatus( $faker->randomElement( [ "confirmed", "cancelled", "tentative" ] ));
